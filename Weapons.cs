...
namespace RandomVehicles
{
    class Weapons
    {
        // From https://wiki.rage.mp/index.php?title=Weapons

        private static Dictionary<string, uint> weapons = new Dictionary<string, uint>()
        {
        ...
        public static uint[] getWeaponHashes()
        {
